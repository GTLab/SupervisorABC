...
<head>
	...
	<title>GTLab Website Coming Soon!</title>
</head>
<body>
<h1>Welcome to GTLab! Our Website is under development.</h1>
<a href="https://github.com/GTLab">Our Project @Github</a>
<?php 
echo date("Y,m,d");
?>

<form action="" method="get">
search: <input type="search" name="user_date" />
<input type="submit" />
</form>
  ...
  <form action="#" method="post"> 
    <section class="loginForm"> 
      ...
      <div class="loginForm_content"> 
        <fieldset> 
          <div class="inputWrap"> 
            <input type="text" name="userName" placeholder="Email/user name/phone number" autofocus required> 
          </div> 
          <div class="inputWrap"> 
